...
public class CalendarGrid extends android.view.View   implements OnClickListener
	...
	//((Activity)getContext()).getLayoutInflater().inflate(R.layout.calendargrid, this);
